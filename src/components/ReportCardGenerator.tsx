...
import { Calendar, School, Users, Download, BookOpen, User, FileText, Settings, MessageSquare, Pencil, Table2, Sliders } from 'lucide-react';
...
const ReportCardSettings = lazy(() => import('./ReportCardSettings'));
...
const sectionConfig = [
  ...
  { id: 'settings', title: 'Report Card Settings', desc: 'Choose the report card font, O-Level & A-Level templates, and stamp position', icon: Sliders, Component: ReportCardSettings },
];
