  ...
  public: {
    Tables: {
      ...
      comment_templates: {
        ...
        Relationships: [
          {
            foreignKeyName: "comment_templates_school_id_fkey"
            columns: ["school_id"]
            isOneToOne: false
            referencedRelation: "schools"
            referencedColumns: ["id"]
      ...
      fee_balance_overrides: {
        ...
        Relationships: [
          {
            foreignKeyName: "fee_balance_overrides_school_id_fkey"
            columns: ["school_id"]
            isOneToOne: false
            referencedRelation: "schools"
            referencedColumns: ["id"]
          ...
          {
            foreignKeyName: "fee_balance_overrides_student_id_fkey"
            columns: ["student_id"]
            isOneToOne: false
            referencedRelation: "students"
            referencedColumns: ["id"]
          ...
          {
            foreignKeyName: "fee_balance_overrides_term_id_fkey"
            columns: ["term_id"]
            isOneToOne: false
      ...
      pending_submissions: {
        ...
        Relationships: [
          ...
          {
            foreignKeyName: "pending_submissions_school_id_fkey"
            columns: ["school_id"]
            isOneToOne: false
            referencedRelation: "schools"
            referencedColumns: ["id"]
      ...
      student_bursaries: {
        ...
        Relationships: [
          {
            foreignKeyName: "student_bursaries_school_id_fkey"
            columns: ["school_id"]
            isOneToOne: false
            referencedRelation: "schools"
            referencedColumns: ["id"]
      ...
      student_payments: {
        ...
        Relationships: [
          ...
          {
            foreignKeyName: "student_payments_term_id_fkey"
            columns: ["term_id"]
            isOneToOne: false
            referencedRelation: "terms"
            referencedColumns: ["id"]
